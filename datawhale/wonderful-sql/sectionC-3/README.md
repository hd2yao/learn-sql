...
### 解析
完整 sql 语句可参考 [sectionC_3.sql](https://github.com/hd2yao/learn-sql/blob/master/datawhale/wonderful-sql/sectionC-3/sectionC_3.sql)
...
> 以上参考：
> [SQL脚本案例【1】连续登录3天的用户](https://mp.weixin.qq.com/s/hGYFaUK-qSJWWCf8T4aejQ)